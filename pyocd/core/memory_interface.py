...
class MemoryInterface:
    ...
    def write64(inout self, addr: Int, value: Int) -> None:
        """@brief Shorthand to write a 64-bit word."""
        self.write_memory(addr, value, 64)

    def write32(inout self, addr: Int, value: Int) -> None:
        """@brief Shorthand to write a 32-bit word."""
        self.write_memory(addr, value, 32)

    def write16(inout self, addr: Int, value: Int) -> None:
        """@brief Shorthand to write a 16-bit halfword."""
        self.write_memory(addr, value, 16)

    def write8(inout self, addr: Int, value: Int) -> None:
        """@brief Shorthand to write a byte."""
        self.write_memory(addr, value, 8)

    @overload
    def read64(inout self, addr: Int) -> Int:
        ...

    @overload
    def read64(inout self, addr: Int, now: Literal[] = True) -> Int:
        ...

    @overload
    def read64(inout self, addr: Int, now: Literal[]) -> Callable[]:
        ...

    @overload
    def read64(inout self, addr: Int, now: bool = True) -> Union[]:
        ...
    ...
    @overload
    def read32(inout self, addr: Int) -> Int:
        ...

    @overload
    def read32(inout self, addr: Int, now: Literal[] = True) -> Int:
        ...

    @overload
    def read32(inout self, addr: Int, now: Literal[]) -> Callable[]:
        ...

    @overload
    def read32(inout self, addr: Int, now: bool = True) -> Union[]:
        ...
    ...
    @overload
    def read16(inout self, addr: Int) -> Int:
        ...

    @overload
    def read16(inout self, addr: Int, now: Literal[] = True) -> Int:
        ...

    @overload
    def read16(inout self, addr: Int, now: Literal[]) -> Callable[]:
        ...

    @overload
    def read16(inout self, addr: Int, now: bool = True) -> Union[]:
        ...
    ...
    @overload
    def read8(inout self, addr: Int) -> Int:
        ...

    @overload
    def read8(inout self, addr: Int, now: Literal[] = True) -> Int:
        ...

    @overload
    def read8(inout self, addr: Int, now: Literal[]) -> Callable[]:
        ...

    @overload
    def read8(inout self, addr: Int, now: bool = True) -> Union[]:
        ...
