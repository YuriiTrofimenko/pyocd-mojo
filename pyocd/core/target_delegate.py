...
class TargetDelegateInterface:
    ...
    def __init__(inout self, session: "Session") -> None:
        self._session = session

    def will_connect(inout self, board: "Board") -> None:
    ...
    def did_connect(inout self, board: "Board") -> None:
    ...
    def will_init_target(inout self, target: "SoCTarget", init_sequence: "CallSequence") -> None:
    ...
    def did_init_target(inout self, target: "SoCTarget") -> None:
    ...
    def will_start_debug_core(inout self, core: "CoreTarget") -> None:
    ...
    def start_debug_core(inout self, core: "CoreTarget") -> DelegateResult:
    ...
    def did_start_debug_core(inout self, core: "CoreTarget") -> None:
    ...
    def will_stop_debug_core(inout self, core: "CoreTarget") -> None:
    ...
    def stop_debug_core(inout self, core: "CoreTarget") -> DelegateResult:
    ...
    def did_stop_debug_core(inout self, core: "CoreTarget") -> None:
    ...
    def will_disconnect(inout self, target: "SoCTarget", resume: bool) -> None:
    ...
    def did_disconnect(inout self, target: "SoCTarget", resume: bool) -> None:
    ...
    def will_reset(inout self, core: "Target", reset_type: "Target.ResetType") -> DelegateResult:
    ...
    def did_reset(inout self, core: "Target", reset_type: "Target.ResetType") -> None:
    ...
    def set_reset_catch(inout self, core: "CoreTarget", reset_type: "Target.ResetType") -> DelegateResult:
    ...
    def clear_reset_catch(inout self, core: "CoreTarget", reset_type: "Target.ResetType") -> None:
    ...
    def mass_erase(inout self, target: "SoCTarget") -> DelegateResult:
    ...
    def trace_start(inout self, target: "SoCTarget", mode: Int) -> None:
    ...
    def trace_stop(inout self, target: "SoCTarget", mode: Int) -> None:
