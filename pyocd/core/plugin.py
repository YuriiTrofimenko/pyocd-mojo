...
class Plugin:
    ...
    def should_load(inout self) -> bool:
        """@brief Whether the plugin should be loaded."""
        return True

    def load(inout self) -> Any:
...
def load_plugin_classes_of_type(plugin_group: str, plugin_dict: Dict[], base_class: type) -> None:
