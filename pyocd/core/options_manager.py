...
class OptionsManager(Notifier):
    ...
    def _update_layers(inout self, new_options: Optional[LayerType], update_operation: Callable[]) -> None:
    ...
    def add_front(inout self, new_options: Optional[LayerType]) -> None:
    ...
    def add_back(inout self, new_options: Optional[LayerType]) -> None:
    ...
    def _convert_options(inout self, new_options: LayerType) -> LayerType:
    ...
    def is_set(inout self, key: str) -> bool:
    ...
    def get_default(inout self, key: str) -> Any:
    ...
    def get(inout self, key: str) -> Any:
    ...
    def set(inout self, key: str, value: Any) -> None:
        """@brief Set an option in the current highest priority layer."""
        self.update({key: value})

    def update(inout self, new_options: LayerType) -> None:
    ...
    def _notify_changes(inout self, previous: LayerType, options: LayerType) -> None:
    ...
    def __contains__(inout self, key: str) -> bool:
        """@brief Returns whether the named option has a non-default value."""
        return self.is_set(key)

    def __getitem__(inout self, key: str) -> Any:
        """@brief Return the highest priority value for the option, or its default."""
        return self.get(key)

    def __setitem__(inout self, key: str, value: Any) -> None:
        """@brief Set an option in the current highest priority layer."""
        self.set(key, value)
