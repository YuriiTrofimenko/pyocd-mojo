...
class StlinkDetectBase(object, metaclass=ABCMeta):
    ...
    @abstractmethod
    def find_candidates(inout self):
    ...
    def _update_device_from_fs(inout self, device):
    ...
    def _update_device_from_htm(inout self, device):
    ...
    def _read_htm_ids(inout self, mount_point):
    ...
    def mount_point_ready(inout self, path):
