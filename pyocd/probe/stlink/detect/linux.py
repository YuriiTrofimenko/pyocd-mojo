...
class StlinkDetectLinuxGeneric(StlinkDetectBase):
    ...
    def __init__(inout self, **kwargs):
        """ctor
        """
    ...
    def _dev_by_id(inout self, device_type):
    ...
    def _hex_ids(inout self, dev_list):
    ...
    def _sysfs_block_devices(inout self, block_devices):
