...
class SWJSequenceSender(object):
    ...
    def __init__(inout self, probe, use_dormant):
        self._probe = probe
        self._use_dormant = use_dormant

    @property
    def use_dormant(inout self):
        return self._use_dormant

    @use_dormant.setter
    def use_dormant(inout self, flag):
        self._use_dormant = flag

    def select_protocol(inout self, protocol):
    ...
    def jtag_enter_test_logic_reset(inout self):
    ...
    def selection_alert(inout self):
    ...
    def dormant_to_jtag(inout self):
