...
class DAPAccessIntf(object):
    ...
    @property
    def protocol_version(inout self):
    ...
    # ------------------------------------------- #
    def connect(inout self, port=None):
    ...
    def swd_sequence(inout self, sequences) -> Tuple[]:
    ...
    def reg_read_repeat(inout self, num_repeats, reg_id, dap_index=0, now=True):
