...
class CMSISDAPVersion:
    ...
    @classmethod
    def minor_versions(cls) -> Set[Tuple[]]:
...
class CMSISDAPProtocol(object):
    ...
    def __init__(inout self, interface):
        self.interface = interface

    def dap_info(inout self, id_):
    ...
    def set_led(inout self, type, enabled):
        cmd = []
    ...
    def connect(inout self, mode=DAP_DEFAULT_PORT):
        cmd = []
    ...
    def write_abort(inout self, data, dap_index=0):
        cmd = []
    ...
    def transfer_configure(inout self, idle_cycles=0x02, wait_retry=0x0050, match_retry=0x0000):
        cmd = []
    ...
    def set_swj_clock(inout self, clock=1000000):
        cmd = []
    ...
    def set_swj_pins(inout self, output, pins, wait=0):
        cmd = []
    ...
    def swd_configure(inout self, turnaround=1, always_send_data_phase=False):
    ...
    def jtag_configure(inout self, devices_irlen=None):
    ...
    def jtag_id_code(inout self, index=0):
        cmd = []
    ...
    def swo_transport(inout self, transport):
        cmd = []
    ...
    def swo_baudrate(inout self, baudrate):
        cmd = []
    ...
    def swo_control(inout self, action):
        cmd = []
    ...
    def vendor(inout self, index, data):
        cmd = []
