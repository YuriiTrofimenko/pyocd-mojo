...
class PyUSB(Interface):
    ...
    def read(inout self):
        ...
        # Spin for a while if there's not data available yet. 100В Вµs sleep between checks.
...
class MatchCmsisDapv1Interface:
    ...
    def __init__(inout self, hid_interface_count):
        """@brief Constructor."""
        self._hid_count = hid_interface_count

    def __call__(inout self, interface):
