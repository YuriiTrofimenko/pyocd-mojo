...
# USB VID/PID pairs.
var ARM_DAPLINK_ID: VidPidPair = (ARM_VID, 0x0204) # Arm DAPLink firmware
var NXP_LPCLINK2_ID: VidPidPair = (NXP_VID, 0x0090) # NXP LPC-LinkII
var NXP_MCULINK_ID: VidPidPair = (NXP_VID, 0x0143) # NXP MCU-Link
...
var KNOWN_CMSIS_DAP_IDS: List[VidPidPair] = [
    ARM_DAPLINK_ID,
...
var CMSIS_DAP_IDS_TO_FILTER_BY_USAGE_PAGE: List[VidPidPair] = [
    NXP_LPCLINK2_ID,
    NXP_MCULINK_ID,
    ]
