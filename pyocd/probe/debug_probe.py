...
class DebugProbe:
    ...
    def __init__(inout self) -> None:
        """@brief Constructor."""
        var self._session: Optional[] = None
        self._lock = threading.RLock()

    @property
    def session(inout self) -> Optional[]:
        """@brief Session associated with this probe."""
        return self._session

    @session.setter
    def session(inout self, the_session: "Session") -> None:
    ...
    @property
    def supported_wire_protocols(inout self) -> Collection[Protocol]:
    ...
    @property
    def wire_protocol(inout self) -> Optional[Protocol]:
    ...
    @property
    def capabilities(inout self) -> Set[Capability]:
    ...
    def connect(inout self, protocol: Optional[Protocol] = None) -> None:
    ...
    def get_memory_interface_for_ap(inout self, ap_address: "APAddressBase") -> Optional[]:
