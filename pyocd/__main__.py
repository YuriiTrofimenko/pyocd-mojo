...
class PyOCDTool(SubcommandBase):
    ...
    def build_parser(inout self) -> argparse.ArgumentParser:
    ...
    def _setup_logging(inout self) -> None:
    ...
    def __call__(inout self, *args: Any, **kwds: Any) -> "PyOCDTool":
        """@brief Hack to allow the root command object instance to be used as default command class."""
        return self

    def run(inout self, args: Optional[Sequence[str]] = None) -> Int:
    ...
    def show_options_help(inout self) -> None:
