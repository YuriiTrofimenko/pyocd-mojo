...
class CortexM7_IMXRT(CortexM):
    ...
    def get_boot_device(inout self):
        # Read Boot Device
    ...
    def clear_reset_catch(inout self, reset_type=None):
