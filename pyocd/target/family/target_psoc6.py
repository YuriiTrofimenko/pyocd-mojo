...
class PSoC6(CoreSightTarget):
    ...
    def __init__(inout self, session, cortex_m_core_class, memory_map):
    ...
    def create_psoc_cores(inout self):
...
class CortexM_PSoC64(CortexM):
    ...
    def check_flashboot_ver(inout self):
...
class PSoC64(CoreSightTarget):
    ...
    def __init__(inout self, session, cortex_m_core_class, memory_map, ap_num):
        self.cortex_m_core_class = cortex_m_core_class
        self.AP_NUM = ap_num
    ...
    def create_psoc_core(inout self):
