...
class LPC5500Family(CoreSightTarget):
    ...
    def modify_discovery(inout self, seq):
    ...
    def set_max_invalid_aps(inout self):
    ...
    def check_locked_state(inout self, seq):
    ...
    def _enable_traceclk(inout self):
...
class CortexM_LPC5500(CortexM_v8M):
    ...
    def reset(inout self, reset_type):
