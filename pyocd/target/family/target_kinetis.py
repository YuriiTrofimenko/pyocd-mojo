...
class Kinetis(CoreSightTarget):
    ...
    def __init__(inout self, session, memory_map=None):
    ...
    def check_mdm_ap_idr(inout self):
        if not self.dp.aps:
    ...
    def check_flash_security(inout self):
...
#                 isLocked = False
    ...
    def perform_halt_on_connect(inout self):
    ...
    def _wait_for_flash_init(inout self):
