...
class LPC1768(CoreSightTarget):
    ...
    def add_core(inout self, core):
        super(LPC1768, self).add_core(core)
        core.delegate = self

    def map_flash(inout self):
        self.write32(0x400FC040, 1)

    def set_reset_catch(inout self, core, reset_type=None):
    ...
    def clear_reset_catch(inout self, core, reset_type=None):
