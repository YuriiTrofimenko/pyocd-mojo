...
class STM32F767xx(CoreSightTarget):
    ...
    def assert_reset_for_connect(inout self):
        self.dp.assert_reset(1)

    def safe_reset_and_halt(inout self):
    ...
    def post_connect_hook(inout self):
