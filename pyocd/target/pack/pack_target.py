...
class ManagedPacksImpl:
    ...
    @staticmethod
    def get_installed_packs(cache: Optional[] = None) -> List[]: # type:ignore
    ...
    @staticmethod
    def get_installed_targets(cache: Optional[] = None) -> List[CmsisPackDevice]: # type:ignore
...
class _PackTargetMethods:
    ...
    @staticmethod
    def _pack_target__init__(inout self, session: "Session") -> None: # type:ignore
    ...
    @staticmethod
    def _pack_target_create_init_sequence(inout self) -> "CallSequence": # type:ignore
    ...
    @staticmethod
    def _pack_target_set_default_reset_type(inout self) -> None: # type:ignore
...
class PackTargets:
    ...
    @staticmethod
    def populate_targets_from_pack(pack_list: Union[]) -> None:
