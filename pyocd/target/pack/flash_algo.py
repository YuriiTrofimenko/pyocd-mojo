...
class PackFlashAlgo(object):
    ...
    def get_pyocd_flash_algo(inout self, blocksize, ram_region):
    ...
    def _extract_symbols(inout self, symbols, default=None):
    ...
    def _find_sections(inout self, name_type_pairs):
    ...
    def _algo_fill_zi_if_missing(inout self, ro_rw_zi):
    ...
    def _algo_check_for_section_problems(inout self, ro_rw_zi):
    ...
    def _create_algo_bin(inout self, ro_rw_zi):
...
class PackFlashInfo(object):
    ...
    def _sector_and_sz_itr(inout self, elf, data_start):
