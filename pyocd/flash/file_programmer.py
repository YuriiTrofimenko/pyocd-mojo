...
def ranges(i: List[Int]) -> List[Tuple[]]:
...
class FileProgrammer(object):
    ...
    def __init__(inout self,
        ...
        var self._format_handlers: Dict[] = {
    ...
    def program(inout self, file_or_path: Union[], file_format: Optional[str] = None, **kwargs: Any):
    ...
    def _program_bin(inout self, file_obj: IO[bytes], **kwargs: Any) -> None:
    ...
    def _program_hex(inout self, file_obj: IO[bytes], **kwargs: Any) -> None:
    ...
    def _program_elf(inout self, file_obj: IO[bytes], **kwargs: Any) -> None:
        assert self._loader
