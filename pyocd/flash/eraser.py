...
class FlashEraser(object):
    ...
    def __init__(inout self, session, mode):
        """@brief Constructor.
    ...
    def erase(inout self, addresses=None):
    ...
    def _sector_erase(inout self, addresses):
        flash = None
        currentRegion = None
    ...
    def _convert_spec(inout self, spec):
