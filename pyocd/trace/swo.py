...
class SWOParser(object):
    ...
    """
    def __init__(inout self, core, sink=None):
        self.reset()
        self._core = core
        self._sink = sink
    ...
    def _merge_data_trace_events(inout self, event):
    ...
    def _send_event(inout self, event):
