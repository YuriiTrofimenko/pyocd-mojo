...
class SWVEventSink(TraceEventSink):
    ...
    def __init__(inout self, console):
        """@brief Constructor.
        @param self
...
class SWVReader(threading.Thread):
    ...
    def __init__(inout self, session, core_number=0, lock=None):
        """@brief Constructor.
        @param self
    ...
    def init(inout self, sys_clock, swo_clock, console) -> bool:
    ...
    def _reset_handler(inout self, notification):
