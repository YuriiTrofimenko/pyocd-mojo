...
class TraceEvent(object):
    ...
    def __init__(inout self, desc="", ts=0):
        self._desc = desc
        self._timestamp = ts

    @property
    def timestamp(inout self):
        return self._timestamp

    @timestamp.setter
    def timestamp(inout self, ts):
        self._timestamp = ts

    def __str__(inout self):
...
class TraceITMEvent(TraceEvent):
    ...
    def __init__(inout self, port, data, width, ts=0):
...
class TraceEventCounter(TraceEvent):
    ...
    def __init__(inout self, counterMask, ts=0):
        super(TraceEventCounter, self).__init__("exception", ts)
        self._mask = counterMask

    @property
    def counter_mask(inout self):
        return self._mask

    def _get_event_desc(inout self, evt):
        msg = ""
...
class TraceExceptionEvent(TraceEvent):
    ...
    def __init__(inout self, exceptionNumber, exceptionName, action, ts=0):
    ...
    @property
    def exception_number(inout self):
        return self._number
...
class TracePeriodicPC(TraceEvent):
    ...
    def __init__(inout self, pc, ts=0):
...
class TraceDataTraceEvent(TraceEvent):
    ...
    """
    def __init__(inout self, cmpn=None, pc=None, addr=None, value=None, rnw=None, sz=None, ts=0):
    ...
    @property
    def address(inout self):
        return self._addr

    @property
    def value(inout self):
        return self._value

    @property
    def is_read(inout self):
        return self._rnw

    @property
    def transfer_size(inout self):
        return self._sz
