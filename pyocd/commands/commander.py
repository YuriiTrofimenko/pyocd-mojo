...
class PyOCDCommander:
    ...
    def __init__(
        ...
        var self.session: Optional[] = None
        var self.exit_code: Int = 0

    def run(inout self) -> Int:
    ...
    def _commands_require_connect(inout self) -> bool:
    ...
    def run_commands(inout self) -> None:
    ...
    def _post_connect(inout self) -> bool:
