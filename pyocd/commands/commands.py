...
class RegisterCommandBase(CommandBase):
    def dump_register_group(inout self, group_name):
    ...
    def dump_registers(inout self, show_all=False, show_group=None):
    ...
    def _dump_peripheral_register(inout self, periph, reg, show_fields):
        size = reg.size or 32
...
Prefix line with ! to execute a shell command."""
    ...
    def _list_commands(inout self, title, command_list, help_format):
        cmds = {}
        nominal_cmds = []
