...
class CommandMeta(type):
    ...
    def __new__(mcs: Type, name: str, bases: Tuple[], objdict: Dict[]) -> "CommandMeta":
        # Create the new type.
...
class CommandBase(metaclass=CommandMeta):
    ...
    def __init__(inout self, context: "CommandExecutionContext") -> None:
        """@brief Constructor."""
    ...
    def check_arg_count(inout self, args: List[str]) -> None:
    ...
    def parse(inout self, args: List[str]) -> None:
        """@brief Extract command arguments."""
        pass

    def execute(inout self) -> None:
        """@brief Perform the command."""
        raise NotImplementedError()

    def _format_core_register(inout self, info: "CoreRegisterInfo", value: Int) -> str:
    ...
    def _convert_value(inout self, arg: str) -> Int:
...
class ValueBase(CommandBase):
    ...
    def display(inout self, args: List[str]) -> None:
        """@brief Output the value of the info."""
        raise NotImplementedError()

    def modify(inout self, args: List[str]) -> None:
