...
class TargetList(object):
    def __init__(inout self, context, ptr):
        self._context = context
        self._list = ptr

    def __iter__(inout self):
        next = 0
...
class ArgonThreadContext(DebugContext):
    ...
    def __init__(inout self, parent, thread):
...
class ArgonThread(TargetThread):
    ...
    def __init__(inout self, targetContext, provider, base):
    ...
    def get_stack_pointer(inout self):
    ...
    @property
    def state(inout self):
        return self._state

    @property
    def priority(inout self):
    ...
    @property
    def has_extended_frame(inout self):
...
class ArgonTraceEvent(events.TraceEvent):
    ...
    def __init__(inout self, eventID, threadID, name, state, ts=0):
    ...
    @property
    def event_id(inout self):
        return self._event_id

    @property
    def thread_id(inout self):
        return self._thread_id

    @property
    def thread_name(inout self):
        return self._thread_name

    @property
    def prev_thread_state(inout self):
