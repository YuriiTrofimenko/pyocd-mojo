...
class TargetList(object):
    def __init__(inout self, context, ptr, next_offset):
...
class ZephyrThread(TargetThread):
    ...
    def __init__(inout self, targetContext, provider, base, offsets):
