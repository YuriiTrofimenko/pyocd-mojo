...
class Bitfield:
    ...
    def __init__(inout self, msb: Int, lsb: Optional[Int] = None, name: Optional[str] = None):
        self._msb = msb
    ...
    @property
    def width(inout self) -> Int:
        return self._msb - self._lsb + 1

    def get(inout self, value: Int) -> Int:
    ...
    def set(inout self, register_value: Int, field_value: Int) -> Int:
