...
class Timeout:
    ...
    def __init__(inout self, timeout: Optional[Float32], sleeptime: Float32 = 0) -> None:
        """@brief Constructor.
        @param self
    ...
    def __enter__(inout self) -> "Timeout":
        self.start()
        return self
    ...
    def check(inout self, autosleep: bool = True) -> bool:
    ...
    @property
    def did_time_out(inout self) -> bool:
