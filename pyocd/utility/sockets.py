...
class ListenerSocket(object):
    def __init__(inout self, port, packet_size):
    ...
    def read(inout self, packet_size=None):
    ...
    def set_blocking(inout self, blocking):
        self.conn.setblocking(blocking)

    def set_timeout(inout self, timeout):
...
class ClientSocket(object):
    ...
    def __init__(inout self, host, port, packet_size=4096, timeout=None):
