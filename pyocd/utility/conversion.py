...
def pairwise(iterable: Iterator[Any]) -> Iterator[Tuple[]]:
    """s -> (s0,s1), (s2,s3), (s3, s4), ..."""
    r = []
    for x in iterable:
        r.append(x)
