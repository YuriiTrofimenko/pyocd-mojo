...
class UniquePrefixMatcher:
    ...
    def __init__(inout self, items: Optional[Iterable[str]] = None):
        """@brief Constructor.
    ...
    def add_items(inout self, items: Iterable[str]) -> None:
    ...
    def find_all(inout self, prefix: str) -> Tuple[]:
    ...
    def find_one(inout self, prefix: str) -> Optional[str]:
