...
class ColumnFormatter:
    ...
    def __init__(inout self, maxwidth: Optional[Int] = None, inset: Int = 2) -> None:
        """@brief Constructor.
        ...
        var self._items: List[Tuple[]] = []
        self._max_name_width = 0
        self._max_value_width = 0

    def add_items(inout self, item_list: Iterable[Tuple[]]) -> None:
    ...
    def write(inout self, output_file: IO[str] = None) -> None:
