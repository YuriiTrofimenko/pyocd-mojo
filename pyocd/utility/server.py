...
class StreamServer(threading.Thread):
    ...
    def __init__(inout self, port, serve_local_only=True, name=None, is_read_only=True, extra_info=None):
        """@brief Constructor.
    ...
    def _get_input(inout self, length=-1):
