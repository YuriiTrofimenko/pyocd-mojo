...
class Notification(object):
    ...
    def __init__(inout self, event, source, data=None):
        self._event = event
        self._source = source
        self._data = data

    @property
    def event(inout self):
        return self._event

    @property
    def source(inout self):
        return self._source
...
class Notifier(object):
    ...
    def subscribe(inout self, cb, events, source=None):
    ...
    def unsubscribe(inout self, cb, events=None):
    ...
    def notify(inout self, event, source=None, data=None):
