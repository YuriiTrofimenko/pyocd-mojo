...
class SVDParser(object):
    ...
    def __init__(inout self, tree, remove_reserved=False):
        self.remove_reserved = remove_reserved
        self._tree = tree
        self._root = self._tree.getroot()

    def _parse_enumerated_value(inout self, enumerated_value_node):
    ...
    def _parse_field(inout self, field_node):
        enumerated_values = []
    ...
    def _parse_registers(inout self, register_node):
        fields = []
    ...
    def _parse_cluster(inout self, cluster_node):
    ...
    def _parse_address_block(inout self, address_block_node):
    ...
    def _parse_interrupt(inout self, interrupt_node):
        return SVDInterrupt(
    ...
    def _parse_peripheral(inout self, peripheral_node):
        # parse registers
    ...
    def _parse_device(inout self, device_node):
        peripherals = []
