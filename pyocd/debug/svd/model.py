...
class SVDElement(object):
    ...
    def _lookup_possibly_derived_attribute(inout self, attr):
    ...
    def get_derived_from(inout self):
        pass  # override in children

    def to_dict(inout self):
...
class SVDEnumeratedValue(SVDElement):
    def __init__(inout self, name, description, value, is_default):
...
class SVDField(SVDElement):
    def __init__(inout self, name, derived_from, description, bit_offset, bit_width, access, enumerated_values, modified_write_values, read_action):
        SVDElement.__init__(self)
        self.name = name
    ...
    def __getattr__(inout self, attr):
...
class SVDRegisterArray(SVDElement):
    ...
    def __init__(inout self, name, derived_from, description, address_offset, size,
...
class SVDRegister(SVDElement):
    def __init__(inout self, name, derived_from, description, address_offset, size, access, protection, reset_value, reset_mask,
...
class SVDRegisterCluster(SVDElement):
    ...
    def updated_register(inout self, reg, clu):
        new_reg = SVDRegister(
...
class SVDRegisterClusterArray(SVDElement):
    ...
    def updated_register(inout self, reg, clu, i):
        new_reg = SVDRegister(
...
class SVDAddressBlock(SVDElement):
    def __init__(inout self, offset, size, usage):
        SVDElement.__init__(self)
        self.offset = offset
        self.size = size
        self.usage = usage
...
class SVDInterrupt(SVDElement):
    def __init__(inout self, name, value, description):
        SVDElement.__init__(self)
        self.name = name
...
class SVDPeripheral(SVDElement):
    def __init__(inout self, name, version, derived_from, description,
...
class SVDCpu(SVDElement):
    def __init__(inout self, name, revision, endian, mpu_present, fpu_present, fpu_dp, icache_present,
...
class SVDDevice(SVDElement):
    def __init__(inout self, vendor, vendor_id, name, version, description, cpu, address_unit_bits, width,
