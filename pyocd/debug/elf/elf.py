...
class ELFSection(MemoryRange):
    ...
    def __init__(inout self, elf, sect):
        self._elf = elf
        self._section = sect
    ...
    @property
    def flags_description(inout self):
        flags = self.flags
        flagsDesc = ""
...
class ELFBinaryFile(object):
    ...
    def __init__(inout self, elf, memory_map=None):
    ...
    def _extract_sections(inout self):
