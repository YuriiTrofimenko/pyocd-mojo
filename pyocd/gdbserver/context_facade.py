...
class GDBDebugContextFacade(object):
    ...
    def __init__(inout self, context):
    ...
    def set_context(inout self, new_context):
        self._context = new_context

    def get_register_context(inout self):
    ...
    def set_register_context(inout self, data):
    ...
    def set_register(inout self, gdb_regnum, data):
    ...
    def gdb_get_register(inout self, gdb_regnum):
    ...
    def get_t_response(inout self, force_signal=None):
    ...
    def get_signal_value(inout self):
    ...
    def _get_reg_index_value_pairs(inout self, reg_list):
    ...
    def get_memory_map_xml(inout self):
    ...
    def _define_xpsr_control_fields(inout self, xml_feature):
    ...
    def _build_target_xml(inout self):
