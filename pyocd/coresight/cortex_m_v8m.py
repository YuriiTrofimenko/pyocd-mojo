...
class CortexM_v8M(CortexM):
    ...
    def __init__(inout self, rootTarget, ap, memory_map=None, core_num=0, cmpid=None, address=None):
    ...
    def _read_core_type(inout self):
    ...
    def _build_registers(inout self):
