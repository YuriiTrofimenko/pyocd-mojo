...
class CoreSightTarget(SoCTarget):
    ...
    def __init__(inout self, session: "Session", memory_map: Optional[] = None) -> None:
        ...
        var self._svd_load_thread: Optional[SVDLoader] = None
        var self._irq_table: Optional[Dict[]] = None
        var self._discoverer: Optional[Callable] = None

    @property
    def aps(inout self) -> Dict[]:
        return self.dp.aps
    ...
    def _create_default_cortex_m_memory_map(inout self) -> MemoryMap:
    ...
    def create_discoverer(inout self) -> None:
    ...
    def pre_connect(inout self) -> None:
    ...
    def perform_halt_on_connect(inout self) -> None:
        """@brief Halt cores.
    ...
    def post_connect(inout self) -> None:
    ...
    def create_flash(inout self) -> None:
    ...
    def check_for_cores(inout self) -> None:
