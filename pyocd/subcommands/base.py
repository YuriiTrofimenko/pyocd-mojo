...
class SubcommandBase:
    ...
    var NAMES: List[str] = []
    var HELP: str = ""
    var EPILOG: Optional[str] = None
    DEFAULT_LOG_LEVEL = logging.INFO
    var SUBCOMMANDS: List[Type[]] = []

    ## Class attribute to store the built subcommand argument parser.
    var parser: Optional[] = None
    ...
    def __init__(inout self, args: argparse.Namespace):
        """@brief Constructor.
    ...
    def _get_pretty_table(inout self, fields: List[str], header: bool = None) -> prettytable.PrettyTable:
