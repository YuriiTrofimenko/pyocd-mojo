    ...
    def invoke(inout self) -> Int:
        ...
        try:
            ...
            with session:
                ...
                var target: SoCTarget = session.board.target

                var memory_map: MemoryMap = target.get_memory_map()
                var ram_region: MemoryRegion = memory_map.get_default_region_of_type(MemoryType.RAM)
