...
class RomMemory(MemoryCache, MemoryInterface):
    ...
    """
    def __init__(inout self, ranges):
        """@brief Constructor.
...
class MockCoreSight(RomMemory):
    ...
    def __init__(inout self, components):
        """@brief Constructor.
    ...
    @property
    def short_description(inout self):
...
class MockCoreSightComponent(object):
    ...
    def __init__(inout self, base, cidr, pidr, **kwargs):
        """@brief Constructor.
        @param self
...
class TestRomMemory:
    def test_r32(inout self, testrom):
    ...
    def test_r16(inout self, testrom):
    ...
    def test_r8(inout self, testrom):
...
class TestMockCoreSight:
    def test_1(inout self, testcoresight):
...
class TestRomTable:
    ...
    def test_m4_rom(inout self, m4_rom):
    ...
    def test_c9_rom(inout self, c9_top_rom):
        # Read ROM table component ID.
