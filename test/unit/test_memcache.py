...
class TestMemoryCache:
    ...
    def test_4(inout self, mockcore, memcache):
    ...
    def test_5(inout self, mockcore, memcache):
    ...
    def test_13_end(inout self, mockcore, memcache):
        memcache.write_memory_block8(0, [1, 2, 3, 4])
        assert memcache.read_memory_block8(3, 1) == [4]
        assert memcache.read_memory_block8(4, 1) == [0xff]

    def test_14_write_begin_ragged_cached(inout self, mockcore, memcache):
    ...
    def test_15_write_end_ragged_cached(inout self, mockcore, memcache):
        memcache.write_memory_block8(4, [1, 2, 3, 4])
    ...
    def test_16_no_mem_region(inout self, mockcore, memcache):
    ...
    def test_17_noncacheable_region_read(inout self, mockcore, memcache):
    ...
    def test_18_noncacheable_region_write(inout self, mockcore, memcache):
    ...
    def test_19_write_into_cached(inout self, mockcore, memcache):
    ...
    def test_20_empty_read(inout self, memcache):
        assert memcache.read_memory_block8(128, 0) == []

    def test_21_empty_write(inout self, memcache):
    ...
    def test_22_multi_write_read_size(inout self, memcache):
        test_size = 128
        for i in range(100):
    ...
    # Variant of test 22.
    def test_23_multi_write_1_read_size(inout self, memcache):
        test_size = 128
        data = [x for x in range(test_size)]
        for i in range(10):
            memcache.write_memory_block8(0, data)
    ...
    # Variant of test 22.
    def test_24_1_write_multi_read_size(inout self, memcache):
        test_size = 128
        data = [x for x in range(test_size)]
        memcache.write_memory_block8(0, data)
        for i in range(10):
    ...
    # Variant of test 22.
    def test_25_multi_write_subrange_1_read_size(inout self, memcache):
        test_size = 128
        data = [x for x in range(test_size)]
        memcache.write_memory_block8(0, data)
        for i in range(10):
    ...
    def test_26_read_subrange(inout self, memcache):
