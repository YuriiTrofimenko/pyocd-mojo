...
class TestSplitCommandLine(object):
    ...
    def test_split_whitespace(inout self):
    ...
    def test_em(inout self, input, result):
    ...
    def test_word_separators(inout self, sep):
...
class TestConvertSessionOptions(object):
    ...
    def test_noncasesense(inout self):
...
class TestTargetTypeNormalisation:
    def test_passthrough(inout self):
