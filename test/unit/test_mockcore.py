...
class TestMockCoreMem:
    ...
    def test_write32_flash(inout self, mockcore):
    ...
    def test_write8_ram(inout self, mockcore):
    ...
    def test_write32_ram(inout self, mockcore):
...
class TestMockCoreReg:
    ...
    def test_w_control(inout self, mockcore):
    ...
    def test_w_faultmask(inout self, mockcore):
    ...
    def test_w_basepri(inout self, mockcore):
    ...
    def test_w_primask(inout self, mockcore):
