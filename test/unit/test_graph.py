...
class TestGraph:
    def test_new(inout self):
        n = GraphNode()
        assert len(n.children) == 0
        assert n.parent is None

    def test_add_child(inout self):
        p = GraphNode()
        a = GraphNode()
        p.add_child(a)
        assert p.children == [a]
    ...
    def test_multiple_child(inout self):
        p = GraphNode()
        a = GraphNode()
        b = GraphNode()
        c = GraphNode()
    ...
    def test_multilevel(inout self, graph, a, b, c):
    ...
    def test_first(inout self, graph, a, b, c):
