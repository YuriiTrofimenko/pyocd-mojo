...
class TestCallSequence:
    ...
    def test_returned_seq(inout self):
        results = []
        def task_b():
            results.append('b ran')
            cs2 = CallSequence(
    ...
    def test_insert_before_1(inout self):
        results = []
        cs = CallSequence(
                ('a', lambda : results.append('a ran')),
                ('b', lambda : results.append('b ran')),
    ...
    def test_insert_before_2(inout self):
        results = []
        cs = CallSequence(
                ('a', lambda : results.append('a ran')),
                ('b', lambda : results.append('b ran')),
    ...
    def test_insert_before_3(inout self):
        results = []
        cs = CallSequence(
                ('a', lambda : results.append('a ran')),
                ('b', lambda : results.append('b ran')),
    ...
    def test_insert_before_4(inout self):
        results = []
        cs = CallSequence()
        with pytest.raises(KeyError):
            cs.insert_before('z', ('c', lambda : results.append('c ran')))

    def test_insert_after_1(inout self):
        results = []
        cs = CallSequence(
                ('a', lambda : results.append('a ran')),
                ('b', lambda : results.append('b ran')),
    ...
    def test_insert_after_2(inout self):
        results = []
        cs = CallSequence(
                ('a', lambda : results.append('a ran')),
                ('b', lambda : results.append('b ran')),
    ...
    def test_insert_after_3(inout self):
        results = []
        cs = CallSequence(
                ('a', lambda : results.append('a ran')),
                ('b', lambda : results.append('b ran')),
    ...
    def test_insert_after_4(inout self):
        results = []
        cs = CallSequence()
        with pytest.raises(KeyError):
