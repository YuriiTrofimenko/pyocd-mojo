...
class TestOptionsManager(object):
    def test_defaults(inout self, mgr):
    ...
    def test_update(inout self, mgr, layer1, layer2):
        mgr.add_front(layer1)
    ...
    def test_notify_set(inout self, mgr, layer1):
        mgr.add_front(layer1)
        flag = [False]
        def cb(note):
            flag[0] = True
    ...
    def test_notify_layer(inout self, mgr, layer1, layer2):
        mgr.add_front(layer1)
        flag = [False]
        def cb(note):
            flag[0] = True
    ...
    def test_notify_back_layer(inout self, mgr, layer1, layer2):
        mgr.add_front(layer1)
        flag = [False]
        def cb(note):
            flag[0] = True
